#Tail 1: Output the last 20 lines of the text file.

tail -n 20

#Tail 2: Display the last 20 characters of an input file.
...
-s, --sleep-interval=N with 
-f, sleep for approximately N seconds (default 1.0) between iterations; with inotify and --pid=P, check process P at least once every N seconds 
-v, --verbose always output headers giving file names 
-z, --zero-terminated line delimiter is NUL, not newline 
--help display this help and exit 
--version output version information and exit NUM may have a multiplier suffix: b 512, kB 1000, K 1024, MB 1000*1000, M 1024*1024, GB 1000*1000*1000, G 1024*1024*1024, and so on for T, P, E, Z, Y. 
...
AUTHOR Written by Paul Rubin, David MacKenzie, Ian Lance Taylor, and Jim Meyering. 
...
SEE ALSO head(1) Full documentation at: <https://www.gnu.org/software/coreutils/tail> or available locally via: info '(coreutils) tail invocation' GNU coreutils 8.30 July 2018 TAIL(1)
